        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-gray-900">{testResult.correctAnswers}</div>
                <div className="text-sm text-gray-600">Acertos</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-gray-900">{formatDuration(testResult.duration)}</div>
              ...
              <DialogContent className="max-w-md">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2 pt-4">
                    ...
                    <Button 
                      onClick={startTest}
                      disabled={!selectedSubject || isLoadingQuestions}
